...
def extract_name_with_groq(query: str, text: str) -> dict:
	...
	control_prompt = (f"""
		...
		- "candidates" может содержать несколько объектов. В каждом укажи "full_name", "position" и два варианта email этого человека в поле "email" по шаблонам ivan.ivanov@company.ru i.ivanov@company.ru для Иван Иванов Иванович и company.ru.
